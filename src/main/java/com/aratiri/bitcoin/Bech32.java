...
/**
 * Bech32 codec used by LNURL and Nostr (npub) protocol paths.
 */
public final class Bech32 {
  ...
  public record Data(String hrp, byte[] data) {
    public Data {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof Data(String otherHrp, byte[] otherData))) {
        return false;
      }
    ...
    public String toString() {
      return "Bech32.Data[hrp=" + hrp + ", data=" + Arrays.toString(data) + "]";
    }
  }
  ...
  public static Data decode(final String bech32) {
    ...
    return new Data(hrp, Arrays.copyOfRange(data, 0, data.length - 6));
  }
